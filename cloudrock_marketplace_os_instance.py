...
DOCUMENTATION = '''
---
module: cloudrock_marketplace_os_instance
short_description: Create, update or delete OpenStack instance via marketplace
version_added: 0.8
description:
  - Create, update or delete OpenStack compute instance via Cloudrock API.
requirements:
  - python = 3.8
  - requests
...
def main():
    module = AnsibleModule(
        argument_spec=cloudrock_resource_argument_spec(
    ...
    try:
        instance, has_changed = send_request_to_cloudrock(client, module)

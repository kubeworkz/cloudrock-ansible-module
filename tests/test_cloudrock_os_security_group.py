...
import cloudrock_os_security_group
...
class SecurityGroupCreateTest(unittest.TestCase):
    ...
    def check_successful_function_call(self):
        has_changed = cloudrock_os_security_group.send_request_to_cloudrock(
    ...
    def check_unsuccessful_function_call(self, msg):
        ...
        self.assertRaisesRegex(
            Exception,
            msg,
            cloudrock_os_security_group.send_request_to_cloudrock,
            self.client,
            self.module,
        )
    ...
    def test_security_group_rules_comparison_with_cidr_positive(self):
        ...
        self.assertTrue(
            cloudrock_os_security_group.compare_rules(local_rules, remote_rules)
        )

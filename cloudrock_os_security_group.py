...
from cloudrock_client import (
    ...
    cloudrock_resource_argument_spec,
)
...
DOCUMENTATION = '''
---
module: cloudrock_os_security_group
...
options:
  ...
  project:
    description:
      - Name or UUID of the Cloudrock project where OpenStack tenant is located.
    required: false
  rules:
    description:
...
def main():
    fields = cloudrock_resource_argument_spec(
    ...
    try:
        has_changed = send_request_to_cloudrock(client, module)
